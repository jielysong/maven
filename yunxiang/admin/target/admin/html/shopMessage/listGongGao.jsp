...
<body>
	...
	<table id="dg" class="easyui-datagrid" title="公告管理页面" style="nowrap:false;width:1100px;height:600px"  toolbar="#toolbar"
			data-options="remoteSort:false,loadMsg:'数据加载中，请稍后...',singleSelect:true,nowrap:false,url:'../shopMessage/getGongGaoData',rownumbers:true,pagination:true,pageSize:20">
        <thead>
            <tr>
